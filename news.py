...
def main():
    q1 = "".join(question1 % (
        title, views)for title, views in newsdb.get_articles())
    q2 = "".join(question2 % (
        name, views)for name, views in newsdb.get_authors())
    q3 = "".join(question3 % (
        day, percentage)for day, percentage in newsdb.get_errors())
